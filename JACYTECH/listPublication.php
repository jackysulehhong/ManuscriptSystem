...
function getManuscript($conn)
{
  ...
  return query($conn, "SELECT manuscript.* FROM `manuscript` JOIN `user_account` ON manuscript.authorID=user_account.id WHERE `status`='pendingPublish' OR `status`='publish'");
}

?>
<div class="container my-5">
 <h2 class="text-center">Publication List</h2>
